...
public class EventManager {
    ...
    public static List<CalendarEvent> events = new ArrayList<>(Arrays.asList(
            new CalendarEvent("Kutya", LocalDate.of(2023, 12, 5), CalendarEventType.TASK, true),
            new CalendarEvent("Kutya", LocalDate.of(2023, 10, 5), CalendarEventType.TASK, false),
            ...
            new CalendarEvent("Pakpak", LocalDate.of(2023, 12, 3), CalendarEventType.REMINDER, false),
            new CalendarEvent("Pakpak", LocalDate.of(2023, 12, 3), CalendarEventType.REMINDER, false),
            new CalendarEvent("DIMATadasdasdasda", LocalDate.of(2023, 12, 4), CalendarEventType.EVENT, false),
            new CalendarEvent("DIMAT", LocalDate.of(2023, 12, 4), CalendarEventType.EVENT, false),
            new CalendarEvent("DIMAT", "B209", LocalDate.of(2023, 12, 4), CalendarEventType.EVENT, false),
            new CalendarEvent("DIMAT", LocalDate.of(2023, 12, 4), CalendarEventType.EVENT, false)
    ));
